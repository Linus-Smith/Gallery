...
public class PhotoDataAdapter implements PhotoViewAdapter.DataCommunicationCallBack {
...
//    private int mFocusHintDirection = FOCUS_HINT_NEXT;
    ...
    public PhotoDataAdapter(Context context,
                            MediaSet mediaSet, Path itemPath, int indexHint) {
