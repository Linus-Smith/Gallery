 ...
 * <p>
 * TODO: reconcile this with StoryAlbumEncoder.
 */
public class StoryAlbumEncoder implements Runnable {
    private static final String TAG = "StoryAlbumEncoder";
     ...
     */
    public StoryAlbumEncoder(VideoEncoderCore encoderCore) {
        ...
        synchronized (mReadyFence) {
            ...
            mRunning = true;
            new Thread(this, "StoryAlbumEncoder").start();
            while (!mReady) {
                try {
                    mReadyFence.wait();
    ...
    private static class EncoderHandler extends Handler {
        private WeakReference<StoryAlbumEncoder> mWeakEncoder;

        public EncoderHandler(StoryAlbumEncoder encoder) {
            mWeakEncoder = new WeakReference<StoryAlbumEncoder>(encoder);
        }
        ...
        public void handleMessage(Message inputMessage) {
            ...
            StoryAlbumEncoder encoder = mWeakEncoder.get();
            if (encoder == null) {
