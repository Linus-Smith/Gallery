...
public class TestGLCanvas implements OnNotifyChangeListener {
    ...
    private static final int NUM_FRAMES = 3;               // two seconds of video
...
//        glPaint.setLineWidth(10);
//        glPaint.setColor(Color.BLUE);
//        canvas.drawLine(0, 0, 1000, 1000, glPaint);
        Log.i("jzf","draw");
        canvas.restore();
    ...
    private Bitmap getBitmap() {
        ...
        Log.i("jzf","bid="+bitmapId);
        Log.i("jzf","pname="+mContext.getPackageName());
